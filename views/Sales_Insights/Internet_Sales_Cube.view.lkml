view: Internet_Sales_Cube {
    ...
    dimension: Geo_State_Hierarchy_Geo_State_Level {
        label: "Geo State Level"
        group_label: "Customer Attributes"
        type: string
        sql: ${TABLE}."Geo State Level";;
    }
    ...
    dimension: Order_m_quarter_sum {
        label: "Order Quarter test"
        group_label: "Date Attributes"
        type: date_time
        sql: ${TABLE}."Order m_quarter_sum";;
    }
    ...
    dimension: Ship_m_quarter_sum {
        label: "Ship Quarter test"
        group_label: "Date Attributes"
        type: date_time
        sql: ${TABLE}."Ship m_quarter_sum";;
    }
    ...
    measure: customercount1 {
        ...
        group_label: "Distinct Count"
        value_format: "#.####"
        type: count_distinct
        sql: ${TABLE}."customercount1";;
    }

    measure: DCproductkey {
        label: "Distinct Product Skus"
        group_label: "Distinct Count"
        type: count_distinct
        sql: ${TABLE}."DCproductkey";;
    }
    ...
    set: Customer_Details {
        fields: [Customer_Hierarchy_Customer_Name,Geography_City_City,orderquantity1,salesamount1]
    }

    set: Shipping_Details {
        fields: [Customer_Hierarchy_Customer_Name,Size,Style,Product_Dimension_Product_Line,Product_Dimension_Product_Category,d_productsubcategoryId,Product_Dimension_Product_Name,Color,Weight,orderquantity1,salesamount1]
    }
