view: Finance_View {
    ...
    dimension: Sales_Type_2 {
        label: "Sales Type2"
        type: string
        sql: ${TABLE}.`Sales Type_2`;;
    }

    dimension: Sales_Amount_Category_Hierarchy_Sales_Amount_Category_Level {
        label: "Sales_Amount_Category Level"
        type: string
        sql: ${TABLE}.`Sales_Amount_Category Level`;;
    }

    dimension: sales_type1_salesorder {
        label: "salesorder"
        type: string
